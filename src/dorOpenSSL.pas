...
//function SHA1(const d: PByte; n: NativeUInt; md: PByte): PAnsiChar; cdecl; external LIB_CRYPTO;
...
function EVP_EncryptInit(ctx: PEVP_CIPHER_CTX; const &type: PEVP_CIPHER; const key: PByte; const iv: PByte): Integer; cdecl; external LIB_CRYPTO;
function EVP_EncryptFinal(ctx: PEVP_CIPHER_CTX; &out: PByte; var outl: Integer): Integer; cdecl; external LIB_CRYPTO;

function EVP_EncryptUpdate(ctx: PEVP_CIPHER_CTX; &out: PByte; var outl: Integer; const &in: PByte; inl: Integer): Integer; cdecl; external LIB_CRYPTO;

function EVP_EncryptInit_ex(ctx: PEVP_CIPHER_CTX; &type: PEVP_CIPHER; imple: PENGINE; const key: PByte; const iv: PByte): Integer; cdecl; external LIB_CRYPTO;
function EVP_EncryptFinal_ex(ctx: PEVP_CIPHER_CTX; &out: PByte; var outl: Integer): Integer; cdecl; external LIB_CRYPTO;

function EVP_DecryptInit(ctx: PEVP_CIPHER_CTX; const &type: PEVP_CIPHER; const key: PByte; const iv: PByte): Integer; cdecl; external LIB_CRYPTO;
function EVP_DecryptFinal(ctx: PEVP_CIPHER_CTX; outm: PByte; var outl: Integer): Integer; cdecl; external LIB_CRYPTO;

function EVP_DecryptUpdate(ctx: PEVP_CIPHER_CTX; &out: PByte; var outl: Integer; const &in: PByte; inl: Integer): Integer; cdecl; external LIB_CRYPTO;

function EVP_DecryptInit_ex(ctx: PEVP_CIPHER_CTX; const &type: PEVP_CIPHER; impl: PENGINE; const key: PByte; const iv: PByte): Integer; cdecl; external LIB_CRYPTO;
...
function EVP_md5_sha1: PEVP_MD; cdecl; external LIB_CRYPTO;

function EVP_blake2b512: PEVP_MD; cdecl; external LIB_CRYPTO;
function EVP_blake2s256: PEVP_MD; cdecl; external LIB_CRYPTO;
...
function EVP_shake128: PEVP_MD; cdecl; external LIB_CRYPTO;
function EVP_shake256: PEVP_MD; cdecl; external LIB_CRYPTO;
...
//function EVP_des_ede3_wrap: PEVP_CIPHER; cdecl; external LIB_CRYPTO;
...
function EVP_aes_128_ccm: PEVP_CIPHER; cdecl; external LIB_CRYPTO;
function EVP_aes_128_gcm: PEVP_CIPHER; cdecl; external LIB_CRYPTO;
function EVP_aes_128_xts: PEVP_CIPHER; cdecl; external LIB_CRYPTO;
function EVP_aes_128_wrap: PEVP_CIPHER; cdecl; external LIB_CRYPTO;
function EVP_aes_128_wrap_pad: PEVP_CIPHER; cdecl; external LIB_CRYPTO;
function EVP_aes_128_ocb: PEVP_CIPHER; cdecl; external LIB_CRYPTO;
...
function EVP_aes_192_ccm: PEVP_CIPHER; cdecl; external LIB_CRYPTO;
function EVP_aes_192_gcm: PEVP_CIPHER; cdecl; external LIB_CRYPTO;
function EVP_aes_192_wrap: PEVP_CIPHER; cdecl; external LIB_CRYPTO;
function EVP_aes_192_wrap_pad: PEVP_CIPHER; cdecl; external LIB_CRYPTO;
function EVP_aes_192_ocb: PEVP_CIPHER; cdecl; external LIB_CRYPTO;
...
function EVP_aes_256_ccm: PEVP_CIPHER; cdecl; external LIB_CRYPTO;
function EVP_aes_256_gcm: PEVP_CIPHER; cdecl; external LIB_CRYPTO;
function EVP_aes_256_xts: PEVP_CIPHER; cdecl; external LIB_CRYPTO;
function EVP_aes_256_wrap: PEVP_CIPHER; cdecl; external LIB_CRYPTO;
function EVP_aes_256_wrap_pad: PEVP_CIPHER; cdecl; external LIB_CRYPTO;
function EVP_aes_256_ocb: PEVP_CIPHER; cdecl; external LIB_CRYPTO;

function EVP_aes_128_cbc_hmac_sha1: PEVP_CIPHER; cdecl; external LIB_CRYPTO;
function EVP_aes_256_cbc_hmac_sha1: PEVP_CIPHER; cdecl; external LIB_CRYPTO;
function EVP_aes_128_cbc_hmac_sha256: PEVP_CIPHER; cdecl; external LIB_CRYPTO;
function EVP_aes_256_cbc_hmac_sha256: PEVP_CIPHER; cdecl; external LIB_CRYPTO;
...
//function EVP_camellia_128_ctr: PEVP_CIPHER; cdecl; external LIB_CRYPTO;
...
//function EVP_camellia_192_ctr: PEVP_CIPHER; cdecl; external LIB_CRYPTO;
...
//function EVP_camellia_256_ctr: PEVP_CIPHER; cdecl; external LIB_CRYPTO;
...
//function BIO_s_dgram_mem: PBIO_METHOD; cdecl; external LIB_CRYPTO;
//function BIO_s_secmem: PBIO_METHOD; cdecl; external LIB_CRYPTO;
...
//function BIO_f_readbuffer: PBIO_METHOD; cdecl; external LIB_CRYPTO;
//function BIO_f_linebuffer: PBIO_METHOD; cdecl; external LIB_CRYPTO;
//function BIO_f_nbio_test: PBIO_METHOD; cdecl; external LIB_CRYPTO;
//function BIO_f_prefix: PBIO_METHOD; cdecl; external LIB_CRYPTO;
//function BIO_s_core: PBIO_METHOD; cdecl; external LIB_CRYPTO;
...
const
  ...
  SSL_OP_CLEANSE_PLAINTEXT                        = UInt64(1 shl 1);
  (* Allow initial connection to servers that don't support RI *)
  SSL_OP_LEGACY_SERVER_CONNECT                    = UInt64(1 shl 2);
  SSL_OP_ENABLE_KTLS                              = UInt64(1 shl 3);
  SSL_OP_TLSEXT_PADDING                           = UInt64(1 shl 4);
  SSL_OP_SAFARI_ECDHE_ECDSA_BUG                   = UInt64(1 shl 6);
  SSL_OP_IGNORE_UNEXPECTED_EOF                    = UInt64(1 shl 7);
  SSL_OP_ALLOW_CLIENT_RENEGOTIATION               = UInt64(1 shl 8);
  SSL_OP_DISABLE_TLSEXT_CA_NAMES                  = UInt64(1 shl 9);
  (* In TLSv1.3 allow a non-(ec)dhe based kex_mode *)
  SSL_OP_ALLOW_NO_DHE_KEX                         = UInt64(1 shl 10);
  (*
   ...
   *)
  SSL_OP_DONT_INSERT_EMPTY_FRAGMENTS              = UInt64(1 shl 11);
  (* DTLS options *)
  SSL_OP_NO_QUERY_MTU                             = UInt64(1 shl 12);
  (* Turn on Cookie Exchange (on relevant for servers) *)
  SSL_OP_COOKIE_EXCHANGE                          = UInt64(1 shl 13);
   ...
   *)
  SSL_OP_CISCO_ANYCONNECT                         = UInt64(1 shl 15);
  (* As server, disallow session resumption on renegotiation *)
  SSL_OP_NO_SESSION_RESUMPTION_ON_RENEGOTIATION   = UInt64(1 shl 16);
  (* Don't use compression even if supported *)
  SSL_OP_NO_COMPRESSION                           = UInt64(1 shl 17);
  (* Permit unsafe legacy renegotiation *)
  SSL_OP_ALLOW_UNSAFE_LEGACY_RENEGOTIATION        = UInt64(1 shl 18);
   ...
   *)
  SSL_OP_ENABLE_MIDDLEBOX_COMPAT                  = UInt64(1 shl 20);
  (*
   * Prioritize Chacha20Poly1305 when client does.
   * Modifies SSL_OP_CIPHER_SERVER_PREFERENCE
   *)
  SSL_OP_PRIORITIZE_CHACHA                        = UInt64(1 shl 21);
  (*
   * Set on servers to choose the cipher according to server's preferences.
   *)
  SSL_OP_CIPHER_SERVER_PREFERENCE                 = UInt64(1 shl 22);
  (*
   ...
   *)
  SSL_OP_TLS_ROLLBACK_BUG                         = UInt64(1 shl 23);
  (*
   ...
   *)
  SSL_OP_NO_ANTI_REPLAY                           = UInt64(1 shl 24);
  SSL_OP_NO_SSLv3                                 = UInt64(1 shl 25);
  SSL_OP_NO_TLSv1                                 = UInt64(1 shl 26);
  SSL_OP_NO_TLSv1_2                               = UInt64(1 shl 27);
  SSL_OP_NO_TLSv1_1                               = UInt64(1 shl 28);
  SSL_OP_NO_TLSv1_3                               = UInt64(1 shl 29);
  SSL_OP_NO_DTLSv1                                = UInt64(1 shl 26);
  SSL_OP_NO_DTLSv1_2                              = UInt64(1 shl 27);
  (* Disallow all renegotiation *)
  SSL_OP_NO_RENEGOTIATION                         = UInt64(1 shl 30);
  (*
   * Make server add server-hello extension from early version of
   * cryptopro draft, when GOST ciphersuite is negotiated. Required for
   * interoperability with CryptoPro CSP 3.x
   *)
  SSL_OP_CRYPTOPRO_TLSEXT_BUG                     = UInt64(1 shl 31);
  (*
   ...
   *)
  SSL_OP_NO_TX_CERTIFICATE_COMPRESSION            = UInt64(1 shl 32);
  SSL_OP_NO_RX_CERTIFICATE_COMPRESSION            = UInt64(1 shl 33);
  (* Enable KTLS TX zerocopy on Linux *)
  SSL_OP_ENABLE_KTLS_TX_ZEROCOPY_SENDFILE         = UInt64(1 shl 34);

  SSL_OP_PREFER_NO_DHE_KEX                        = UInt64(1 shl 35);

(*
 * Option "collections."
 *)
  SSL_OP_NO_SSL_MASK =
        ( SSL_OP_NO_SSLv3 or SSL_OP_NO_TLSv1 or SSL_OP_NO_TLSv1_1 or
          SSL_OP_NO_TLSv1_2 or SSL_OP_NO_TLSv1_3 );
  SSL_OP_NO_DTLS_MASK =
        ( SSL_OP_NO_DTLSv1 or SSL_OP_NO_DTLSv1_2 );

(* Various bug workarounds that should be rather harmless. *)
  SSL_OP_ALL =
        ( SSL_OP_CRYPTOPRO_TLSEXT_BUG or SSL_OP_DONT_INSERT_EMPTY_FRAGMENTS or
          SSL_OP_TLSEXT_PADDING or SSL_OP_SAFARI_ECDHE_ECDSA_BUG );
...
//  PPPKCS7 = ^PPKCS7;
  ...
  function SSL_CTX_set_cipher_list(ctx: PSSL_CTX; const str: PAnsiChar): Integer; cdecl; external LIB_SSL;
...
//  procedure SSL_CTX_set_cert_store(ctx: PSSL_CTX; store: PX509_STORE); cdecl; external LIB_CRYPTO;
  ...
  function SSL_CTX_set_options(ctx: PSSL_CTX; op: UInt64): UInt64; cdecl; external LIB_SSL;
  function SSL_CTX_clear_options(ctx: PSSL_CTX; op: UInt64): UInt64; cdecl; external LIB_SSL;
  function SSL_CTX_get_options(ctx: PSSL_CTX): UInt64; cdecl; external LIB_SSL;
...
//  function SSL_has_pending(const ssl: PSSL): Integer; cdecl; external LIB_SSL;
  function SSL_get1_peer_certificate(ssl: PSSL): PX509; cdecl; external LIB_SSL;
